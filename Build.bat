...
set CommonCompilerFlags= -std=c++1y "-IC:\\Users\\Zaeem/wpilib/cpp/current/include" "-IZ:\\FRC\\Repositories\\ELON-Engine\\src" -O0 -g3 -Wall
...
arm-frc-linux-gnueabi-g++ "-LC:\\Users\\Zaeem/wpilib/cpp/current/lib" -Wl,-rpath,/opt/GenICam_v2_3/bin/Linux_armv7-a -o "..\\..\\bin\\FRCUserProgram" "EHL.o" -lwpi 
